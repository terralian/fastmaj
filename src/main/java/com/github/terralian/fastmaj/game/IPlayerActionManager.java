...
public interface IPlayerActionManager {
     ...
     */
    Set<RiverActionType> validateRiverActions(int position, TehaiActionValue rivalTehaiAction, GameConfig gameConfig, IGameCore gameCore,
     ...
     * @param context 玩家游戏上下文
     */
    boolean validateRiverAction(RiverActionType actionType, int position, TehaiActionValue rivalTehaiAction, GameConfig gameConfig,
            IGameCore gameCore,
            PlayerGameContext context);
