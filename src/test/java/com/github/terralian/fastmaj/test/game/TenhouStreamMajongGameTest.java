...
public class TenhouStreamMajongGameTest {
    ...
    public void test4() throws Exception {
        TenhouTestPlayerBuilder builder = new TenhouTestPlayerBuilder();
        String fileName = "tehou/2014050706gm-0041-0000-0f2d0390&tw=1.mjlog";
        builder.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    ...
    public void test5() throws Exception {
        TenhouTestPlayerBuilder builder = new TenhouTestPlayerBuilder();
        String fileName = "tehou/2014050706gm-0041-0000-d961758c&tw=3.mjlog";
        builder.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    ...
    public void test7() throws Exception {
        TenhouTestPlayerBuilder builder = new TenhouTestPlayerBuilder();
        String fileName = "tehou/2014050821gm-0041-0000-defb2e94&tw=0.mjlog";
        builder.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    ...
    public void test9() throws Exception {
        TenhouTestPlayerBuilder builder = new TenhouTestPlayerBuilder();
        String fileName = "tehou/2014050912gm-0041-0000-5b9bd6a8&tw=1.mjlog";
        builder.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    ...
    public void test10() throws Exception {
        TenhouTestPlayerBuilder builder = new TenhouTestPlayerBuilder();
        String fileName = "tehou/2014051204gm-0041-0000-c9ebd8d8&tw=1.mjlog";
        builder.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    ...
    public void test12() throws Exception {
        TenhouTestPlayerBuilder builder = new TenhouTestPlayerBuilder();
        String fileName = "tehou/2014051313gm-0041-0000-c7bd6c03&tw=3.mjlog";
        builder.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    ...
    public void test13() throws Exception {
        TenhouTestPlayerBuilder builder = new TenhouTestPlayerBuilder();
        String fileName = "tehou/2014051419gm-0041-0000-7ec58083&tw=1.mjlog";
        builder.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    ...
    public void test14() throws Exception {
        TenhouTestPlayerBuilder builder = new TenhouTestPlayerBuilder();
        String fileName = "tehou/2014051420gm-0041-0000-f7f77570&tw=0.mjlog";
        builder.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    ...
    public void test16() throws Exception {
        TenhouTestPlayerBuilder builder = new TenhouTestPlayerBuilder();
        String fileName = "tehou/2014051613gm-0041-0000-3366561a&tw=0.mjlog";
        builder.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    ...
    public void test18() throws Exception {
        TenhouTestPlayerBuilder builder = new TenhouTestPlayerBuilder();
        String fileName = "tehou/2014052606gm-00c1-0000-6c0dfa74&tw=1.mjlog";
        builder.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    ...
    public void test19() throws Exception {
        TenhouTestPlayerBuilder builder = new TenhouTestPlayerBuilder();
        String fileName = "tehou/2014052711gm-00c1-0000-82c05143&tw=1.mjlog";
        builder.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    ...
    public void test20() throws Exception {
        TenhouTestPlayerBuilder builder = new TenhouTestPlayerBuilder();
        String fileName = "tehou/2014060412gm-00c1-0000-abd08a3d&tw=2.mjlog";
        builder.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    ...
    public void test21() throws Exception {
        TenhouTestPlayerBuilder builder = new TenhouTestPlayerBuilder();
        String fileName = "tehou/2014060512gm-00c1-0000-59befdce&tw=1.mjlog";
        builder.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    ...
    public void test22() throws Exception {
        TenhouTestPlayerBuilder builder = new TenhouTestPlayerBuilder();
        String fileName = "tehou/2014060512gm-00c1-0000-eb8a80a7&tw=3.mjlog";
        builder.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    ...
    public void test24() throws Exception {
        TenhouTestPlayerBuilder builder = new TenhouTestPlayerBuilder();
        String fileName = "tehou/2014060513gm-00c1-0000-b2530541&tw=0.mjlog";
        builder.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    ...
    public void test28() throws Exception {
        TenhouTestPlayerBuilder builder = new TenhouTestPlayerBuilder();
        String fileName = "tehou/2014120511gm-0029-0000-511b245b&tw=0.mjlog";
        builder.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    ...
    public void test29() throws Exception {
        TenhouTestPlayerBuilder builder = new TenhouTestPlayerBuilder();
        String fileName = "tehou/2014120816gm-0029-0000-6c78c8b6&tw=3.mjlog";
        builder.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    ...
    public void test31() throws Exception {
        TenhouTestPlayerBuilder builder = new TenhouTestPlayerBuilder();
        String fileName = "tehou/2015011211gm-0029-0000-2dd7ec0f&tw=3.mjlog";
        builder.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    ...
    public void test32() throws Exception {
        TenhouTestPlayerBuilder builder = new TenhouTestPlayerBuilder();
        String fileName = "tehou/2015041416gm-0029-0000-5e89a32a&tw=0.mjlog";
        builder.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    ...
    public void test33() throws Exception {
        TenhouTestPlayerBuilder builder = new TenhouTestPlayerBuilder();
        String fileName = "tehou/2015050103gm-0029-0000-c8a73922&tw=1.mjlog";
        builder.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    ...
    public void test35() throws Exception {
        TenhouTestPlayerBuilder builder = new TenhouTestPlayerBuilder();
        String fileName = "tehou/2015070614gm-00a9-0000-a76c73b1&tw=2.mjlog";
        builder.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    ...
    public void test36() throws Exception {
        TenhouTestPlayerBuilder builder = new TenhouTestPlayerBuilder();
        String fileName = "tehou/2016110202gm-00a9-0000-9bd0c557&tw=3.mjlog";
        builder.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    ...
    public void test37() throws Exception {
        TenhouTestPlayerBuilder builder = new TenhouTestPlayerBuilder();
        String fileName = "tehou/2018120719gm-00a9-0000-f41035fe&tw=2.mjlog";
        builder.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    ...
    public void test39() throws Exception {
        TenhouTestPlayerBuilder builder = new TenhouTestPlayerBuilder();
        String fileName = "tehou/2021072417gm-00a9-0000-bd1e1772&tw=1.mjlog";
        builder.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
