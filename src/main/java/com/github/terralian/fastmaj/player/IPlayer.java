 ...
 * 及其他玩家手牌动作后，进行牌河动作处理{@link RiverActionEvent}（鸣牌，荣和）两种。
 * <p/>
...
public interface IPlayer {
    ...
    /**
     * 鸣牌或者荣和，通过{@link RiverActionEvent}创建操作，若跳过支持返回null，但是建议使用{@link ActionEvents#SKIP}.
     *
     * @param fromPosition 从玩家
     * @param fromDealAction 玩家的动作
     * @param enableActions 我可执行的动作（必有一个）
     * @param context 玩家游戏上下文
     * @return null | {@link RiverActionEvent}
     */
