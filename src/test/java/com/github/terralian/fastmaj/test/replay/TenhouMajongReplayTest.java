...
public class TenhouMajongReplayTest extends TenhouMajongReplay {
    ...
    public void test2() throws Exception {
        ((PrintGameLogger) gameLogger).setShortKyokuSummary(true);
        String fileName = "tenhou/2014050315gm-0041-0000-6babc3e5&tw=0.mjlog";
        this.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    }
    ...
    public void test4() throws Exception {
        ((PrintGameLogger) gameLogger).setShortKyokuSummary(false);
        String fileName = "tenhou/2014050706gm-0041-0000-4e38a006&tw=1.mjlog";
        this.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    }
    ...
    public void test6() throws Exception {
        ((PrintGameLogger) gameLogger).setShortKyokuSummary(false);
        String fileName = "tenhou/2014050821gm-0041-0000-a1298f1a&tw=2.mjlog";
        this.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    }
    ...
    public void test10() throws Exception {
        ((PrintGameLogger) gameLogger).setShortKyokuSummary(true);
        String fileName = "tenhou/2014052604gm-0041-0000-dc1795af&tw=3.mjlog";
        this.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    }
    ...
    public void test14() throws Exception {
        ((PrintGameLogger) gameLogger).setShortKyokuSummary(false);
        String fileName = "tenhou/2014112412gm-00c1-0000-bfbe4417&tw=1.mjlog";
        this.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    }
    ...
    public void test16() throws Exception {
        ((PrintGameLogger) gameLogger).setShortKyokuSummary(true);
        String fileName = "tenhou/2014120822gm-0029-0000-808ea6c0&tw=0.mjlog";
        this.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    }
    ...
    public void test18() throws Exception {
        ((PrintGameLogger) gameLogger).setShortKyokuSummary(true);
        String fileName = "tenhou/2014120823gm-0029-0000-26f781c3&tw=0.mjlog";
        this.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    }
    ...
    public void test19() throws Exception {
        ((PrintGameLogger) gameLogger).setShortKyokuSummary(false);
        String fileName = "tenhou/2014123118gm-0029-0000-4700b218&tw=0.mjlog";
        this.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    }
    ...
    public void test21() throws Exception {
        ((PrintGameLogger) gameLogger).setShortKyokuSummary(false);
        String fileName = "tenhou/2015080113gm-00a9-0000-0213ac0c&tw=3.mjlog";
        this.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    }
    ...
    public void test22() throws Exception {
        ((PrintGameLogger) gameLogger).setShortKyokuSummary(false);
        String fileName = "tenhou/2015082211gm-00a9-0000-b665ff0a&tw=1.mjlog";
        this.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    }
    ...
    public void test23() throws Exception {
        ((PrintGameLogger) gameLogger).setShortKyokuSummary(false);
        String fileName = "tenhou/2018061303gm-00a9-0000-5a8850e9&tw=2.mjlog";
        this.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    }
    ...
    public void test24() throws Exception {
        ((PrintGameLogger) gameLogger).setShortKyokuSummary(false);
        String fileName = "tenhou/2019050400gm-00a9-0000-8c08e32a&tw=3.mjlog";
        this.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    }
    ...
    public void test26() throws Exception {
        ((PrintGameLogger) gameLogger).setShortKyokuSummary(false);
        String fileName = "tenhou/2021041720gm-00a9-0000-f3b19e15&tw=3.mjlog";
        this.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    }
    ...
    public void test28() throws Exception {
        ((PrintGameLogger) gameLogger).setShortKyokuSummary(true);
        String fileName = "tenhou/2021100323gm-00a9-0000-d0ac1302&tw=1.mjlog";
        this.getPaifuParser().parseStream(this.getClass().getClassLoader().getResourceAsStream(fileName));
    }
}
